...
export const PROGRAMAS_POR_FACULTAD: Record<string, string[]> = {
  "CIENCIAS NATURALES Y EXACTAS": Array.from(
    new Set(
      PROGRAMAS_ACADEMICOS
  ...
  "CIENCIAS SOCIALES Y ECONÓMICAS": Array.from(
    new Set(
      PROGRAMAS_ACADEMICOS
  ...
  "EDUCACIÓN Y PEDAGOGÍA": Array.from(
    new Set(
      PROGRAMAS_ACADEMICOS
  ...
  "CIENCIAS DE LA ADMINISTRACIÓN": Array.from(
    new Set(
      PROGRAMAS_ACADEMICOS
  ...
  "DERECHO Y CIENCIA POLÍTICA": Array.from(
    new Set(
      PROGRAMAS_ACADEMICOS
